...
public class UserTests {
	...
	public void test_createUser() {
		...
		// Sending POST request to create a new user
	    	...
	    	Response postUserResponse = UserEndPoint.createUser(userPayload);
	...
	public void test_getUserByName() {
	    ...
	    try {
	        Response getUserResponse = UserEndPoint.readUser(userPayload.getUsername());
	...
	public void test_updateUserByName() {
	    ...
	    try {
	       ...
	       Response putUserResponse = UserEndPoint.updateUser(userPayload.getUsername(), userPayload);
	...
	public void test_deleteUserByName() {
		Response deleteUserResponse = UserEndPoint.deleteUser(this.userPayload.getUsername());
	...
	public void test_loginUser() {
	    ...
	    try {
	        // Send login request
	        Response getLoginUserResponse = UserEndPoint.loginUser(userPayload.getUsername(), userPayload.getPassword());
	...
	public void test_logoutUser() 
	{
	    ...
	    try {
	        ...
	        Response getLogoutUsertResponse = UserEndPoint.logoutUser();
